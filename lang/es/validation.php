...
return [
    ...
    'attributes' => [
        ...
        'references.0.name' => 'nombre',
        'references.0.email' => 'correo',
        'references.0.phone' => 'teléfono',
        'references.*.name' => 'nombre',
        'references.*.email' => 'correo',
        'references.*.phone' => 'teléfono',
        // Campos de curriculum de profesor
        'semester' => 'semestre',
