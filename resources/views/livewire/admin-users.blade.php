            ...
            <x-modal-form>
                ...
                <x-slot:modal-body>
                    <form class="w-full p-5 space-y-3" wire:submit.prevent='addUser' novalidate>
                        {{-- Tipo de usuario --}}
                        <div class="w-full">
                            <x-label for="admin">Tipo de usuario</x-label>
                            <x-select wire:model.defer="admin" id="admin">
                                <x-select-option value="0">Usuario</x-select-option>
                                <x-select-option value="1">Administrador</x-select-option>
                            </x-select>
                        </div>
                        {{-- Nombre --}}
                        <div class="w-full">
                        ...
                        <div
                            ...
                            <x-primary-button data-modal-hide="defaultModal" type="button"
